...
#define APP_NODE_NAME                                               "Test.node"
...
#define UAVCAN_EQUIPMENT_GNSS_FIX_SIZE                              78

#define UAVCAN_EQUIPMENT_GNSS_FIX2_ID                               1063
#define UAVCAN_EQUIPMENT_GNSS_FIX2_SIGNATURE                        0xca41e7000f37435f
#define UAVCAN_EQUIPMENT_GNSS_FIX2_SIZE                             222

#define UAVCAN_EQUIPMENT_GNSS_AUX_ID                                1061
#define UAVCAN_EQUIPMENT_GNSS_AUX_SIGNATURE                         0x9be8bdc4c3dbbfd2
#define UAVCAN_EQUIPMENT_GNSS_AUX_SIZE                              16
...
param_t parameters[] =
{
  // name,    start value, minVal, maxVal, defVal
  {"Test 0",       0,        10,     20,     15},
  {"Test 1",       1,         0,    100,     25},
  {"Test 2",       2,         2,      8,      3},
};
